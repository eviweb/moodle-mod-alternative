...
/**
 * The mod_alternative reminder sent event class.
 *
...
class reminder_sent extends \core\event\base
{
    ...
    public static function get_name() {
        return get_string('eventremindersent', 'mod_alternative');
    }
    ...
    public function get_description() {
        return "A reminder was sent to users registered to the alternative named '" . s($this->other['alternativename']) ."'";
    }
    ...
    public function get_url() {
        return new \moodle_url(
            '/mod/alternative/sendreminder.php',
            array(
    ...
    protected function get_legacy_logdata() {
        return array(
            $this->courseid,
            'alternative',
            'reminder '.($this->other['errors'] !== false ? 'sent' : 'NOT cleanly sent'),
