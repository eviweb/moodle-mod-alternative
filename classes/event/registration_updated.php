...
/**
 * The mod_alternative registration updated event class.
 *
...
class registration_updated extends \core\event\base
{
    ...
    public static function get_name() {
        return get_string('eventregistrationupdated', 'mod_alternative');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated registrations for the alternative '" . s($this->other['alternativename']) . "' with " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/alternative/view.php', array('id' => $this->contextinstanceid));
    }
